                            ...
                            <div class="f-flex justify-content-between align-items-center header-actions mx-2 row mt-75">
                                ...
                                <div class="col-sm-12 col-lg-6 ps-xl-75 ps-0">
                                    <div class="dt-action-buttons d-flex align-items-center justify-content-center justify-content-lg-end flex-lg-nowrap flex-wrap">
                                        <div class="dt-buttons d-inline-flex mt-50">
                                            <a href="{{url('admin/permission/create')}}" style="color:white;"><button type="button" class="dt-button add-new btn btn-primary" tabindex="0" data-bs-target="#modals-slide-in" aria-controls="DataTables_Table_0">
                                                Thêm mới
                                            </button></a>
                                        </div>
                                    </div>
                        ...
                        <table class="w-100 user-list-table table dataTable no-footer dtr-column text-center" style="overflow: hidden;display: block;">
                            ...
                            <tbody>
                                ...
                                <tr data-dt-row="" data-dt-column="">                             
                                       ...
                                       {{-- <td><a href="http://localhost:8000/admin/post/details/{{$permission->id}}"><button type="button" class="btn btn-gradient-info"><i data-feather='eye'></i></button></a></td>
                                       <td><a href="http://localhost:8000/admin/post/edit/{{$permission->id}}"><button type="button" class="btn btn-gradient-success"><i data-feather='edit'></i></button></a></td>--}}
                                       <td><a href="http://localhost:8000/admin/permission/delete/{{$permission->id}}"><button type="button" class="btn btn-gradient-danger"><i data-feather='trash-2'></i></button></a></td>                               
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
