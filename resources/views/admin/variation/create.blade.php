                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" novalidate
                                    action="{{url('/admin/product/addVariation')}}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf

                                    <div class="mb-1">
                                        <label class="d-block form-label fs-5 fw-bolder" for="">Biến thể sản
                                            phẩm</label>
                                    </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="basic-addon-name" class="form-control"
                                            placeholder="Nhập giá trị biến thể" name="{{$variation->id}}_value"
                                    ...
                                    <div class="mb-2">
                                        <label for="customFile1" class="form-label fs-5 fw-bolder">Ảnh biến thể sản
                                            phẩm</label>
                                        <input class="form-control" name="combination_image" type="file"
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input class="form-control" name="price" type="number" id="customFile1"
                                            required />
                                    </div>
                                    <div class="mb-2">
